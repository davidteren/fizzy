...
# Enable fixture UUID support in development environment
#
# The test environment uses FixturesTestHelper (defined in test/test_helper.rb)
# to handle the `_uuid` suffix convention for fixture references. This initializer
# provides the same support in development so that `bin/rails db:fixtures:load`
# correctly resolves fixture associations.
#
# Without this, fixture references like `account: 37s_uuid` generate different
# UUIDs than the actual records, breaking associations.

if Rails.env.development?
  module FixtureUuidSupport
